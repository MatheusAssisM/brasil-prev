...
class PlayerFactory:
    ...
    def create_impulsive_player(
        name: str = "Impulsive Player", balance: int = settings.INITIAL_BALANCE
    ) -> Player:
        """
    ...
    def create_demanding_player(
        ...
        rent_threshold: int = settings.DEMANDING_RENT_THRESHOLD,
    ) -> Player:
        """
    ...
    def create_cautious_player(
        ...
        balance: int = settings.INITIAL_BALANCE,
        reserve_threshold: int = settings.CAUTIOUS_RESERVE_THRESHOLD,
    ) -> Player:
        """
    ...
    def create_random_player(
        name: str = "Random Player", balance: int = settings.INITIAL_BALANCE
    ) -> Player:
        """
